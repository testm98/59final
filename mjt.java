...
int few=6;
float losterFar;
Lobster colony= new Lobster();
Lobster cluster[]= new Lobster[mjt];
...
void setup() {
  ...
  void reset() {
    ...
    for ( int i=0; i<several; i++ ) {
     ...
     ///lobsters//
     float lobsterx= spacing;
     for ( int i=0; i<mjt; i++ ) {
       cluster[i]= new Lobster( i, lobsterx );
       lobsterx += lobsterFar;
   }
  }
...
void scene() {
  ...
  void action() { //boat,squid,loster movement//
...
//////MOVE AND SHOW METHOD////
 ...
 ////DISPLAY SQUID//////
  void show() {
    ...
    fill(255,0,0);
    strokeWeight(0);
    triangle(width-5, surface+40, width-30, surface+20, width-5, surface+5);
    triangle(width-40, surface+80, width-40, surface+60, width-10, surface+80); 
   triangle(width-75, surface+120, width-50, surface+100, width-15, surface+120);
